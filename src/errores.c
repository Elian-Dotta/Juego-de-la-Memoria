...
const char* errores_obtener_detalle(tError err)
{
    switch (err) {
        ...
        case ERR_ARCHIVO:               return "No se pudo abrir o encontrar el archivo";
        case ERR_FRAMEBUFFER:           return "No se pudo crear un framebuffer";
        case ERR_CONFIG_INVALIDA:       return "El archivo de configuracion tiene un formato invalido o valores invalidos";
        case ERR_PARAMETRO_INVALIDO:    return "Se paso un parametro invalido a una funcion";
